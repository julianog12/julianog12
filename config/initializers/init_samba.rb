if Rails.env == 'production'
  ...
  vCreDesenv = "echo Utilid@de5 | sudo -S mount -t cifs //admis19v/CreUniDev/R10_credi_des/lst  /var/coamo/unifacedes/r10_credi_des/proclisting -o username=uniface_user,password=fatserver,workgroup=coamo,uid=root,gid=root"
  vCreProd   = "echo Utilid@de5 | sudo -S mount -t cifs //admis19v/CreUniDev/R10_credi_pro/lst  /var/coamo/unifacedes/r10_credi_pro/proclisting -o username=uniface_user,password=fatserver,workgroup=coamo,uid=root,gid=root"
