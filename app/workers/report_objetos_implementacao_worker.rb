class ReportObjetosImplementacaoWorker
  ...
  def perform(empresa)
    ...
    total_includes = Funcao.where("cd_empresa = ? and tipo =  'include'", empresa.to_s).count
    ...
    dados = {componentes: total_componentes, includes: total_includes, operations: total_operations}
